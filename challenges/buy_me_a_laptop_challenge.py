...
# # #     print(f'All laptops names: {laptop}')
...
for laptop in laptops:
    print(laptop['productName'])
    for type in laptop['types']:
        print(type['screen_size'])
        for option in type['price']:
            print(f"$ {option}")